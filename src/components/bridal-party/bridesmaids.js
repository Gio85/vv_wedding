        ...
        <section className="section">
            ...
            <div className="columns is-variable is-1-mobile is-0-tablet is-3-desktop is-8-widescreen is-2-fullhd u-margin-bottom-small">
                <div className="column">
                    ...
                    <div className="bridal_image">
                        <img
                            src="/images/brides_maids/IMG_0010.JPG"
                            alt="bride"
                        />
                    </div>
                </div>
                <div className="column">
                    ...
                    <div className="bridal_image">
                        <img
                            src="/images/brides_maids/IMG_0016.JPG"
                            alt="bride"
                        />
                    </div>
                </div>
            ...
            <div className="columns is-variable is-1-mobile is-0-tablet is-3-desktop is-8-widescreen is-2-fullhd">
                <div className="column">
                    ...
                    <div className="bridal_image">
                        <img
                            src="/images/brides_maids/camille.JPG"
                            alt="bride"
                        />
                    </div>
                </div>
                <div className="column">
                    ...
                    <div className="bridal_image">
                        <img
                            src="/images/brides_maids/IMG_5334.JPG"
                            alt="bride"
                        />
                    </div>
                </div>
                <div className="column">
                    ...
                    <div className="bridal_image">
                        <img
                            src="/images/brides_maids/IMG_4171.JPG"
                            alt="bride"
                        />
                    </div>
                </div>
