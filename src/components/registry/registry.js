...
export default function Registry() {
    ...
    font-size: 6.8rem;*/}
            ...
            <p className="paragraphRegistry">
                ...
                However, if you do wish to celebrate with a gift, a contribution
                to our honeymoon would be warmly appreciated.
            </p>
            ...
            <p className="paragraph description">
                ...
                <p>
                    <span className="bold">Beneficiary: </span> Vincenzo
                    Vessichelli
                </p>
                <p>
