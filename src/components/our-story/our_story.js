  ...
  return (
    <section className="hero">
      <div className="ourStory">
        ...
        <p className="storyParagraph">
          The story of two star-crossed lovers was about to start. The crazy Vincenzo, was making his living as a barista, but London had far more
          challenges for him.
        </p>
        <p className="storyParagraph">
          He did not know that the providence was preserving him something special and one day, Vera burnished as a Brightstar, "she doth teach the
          torches to burn bright!".
        </p>
        <p className="storyParagraph">
          Vincenzo couldn’t stand such beauty and instantly he realised that his heart did not know love until now. But once again the challenge was
          in every morning and the language gave him a warning.
        </p>
        <p className="storyParagraph">
